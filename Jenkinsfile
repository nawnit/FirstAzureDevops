		...
		stage('Deployment') {
	    	steps {
				...
				sh 'sshpass -p "1234" ssh nawnit@172.17.0.3 "JAVA_HOME=/home/nawnit/Distros/jdk1.8.0_241" "/home/nawnit/Distros/apache-tomcat-8.5.53/bin/startup.sh"'
                            ...
                            //    sh 'sshpass -p 1234 scp target/firstwebapp.war nawnit@172.17.0.4:/home/nitin/Distros/apache-tomcat-8.5.51/webapps'
				//sh 'sshpass -p 1234 ssh niti@172.17.0.4 "JAVA_HOME=/home/nitin/Distros/jdk1.8.0_241" "/home/nitin/Distros/apache-tomcat-8.5.51/bin/startup.sh"'
